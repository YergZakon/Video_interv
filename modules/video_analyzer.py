...
class VideoAnalyzer:
    ...
    def _visualize_face_regions(self, frame, x, y, w, h):
        ...
        regions_coords = {
            'forehead': (x, y, w, int(h * 0.2)),
            'eyebrows': (x, y + int(h * 0.2), w, int(h * 0.15)),
            'eyes': (x, y + int(h * 0.35), w, int(h * 0.15)),
            'nose': (x + int(w * 0.25), y + int(h * 0.5), int(w * 0.5), int(h * 0.15)),
            'mouth': (x + int(w * 0.25), y + int(h * 0.65), int(w * 0.5), int(h * 0.15)),
            'chin': (x, y + int(h * 0.8), w, int(h * 0.2))
        }
